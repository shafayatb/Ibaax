 ...
 */
public class DirectoryPagerDeveloperAdapter extends PagerAdapter {
    ...
    public DirectoryPagerDeveloperAdapter(Context context, List<Developer> list, IProperty listener) {
