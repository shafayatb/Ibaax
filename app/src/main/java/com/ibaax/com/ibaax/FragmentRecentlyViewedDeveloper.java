 ...
 */
public class FragmentRecentlyViewedDeveloper extends Fragment {
    ...
    public FragmentRecentlyViewedDeveloper() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lblNoRecentlyViewed.setText("You currently don't have any recently viewed developers.");
    ...
    void HttpGetRecentlyViewed() {
        try {
            developerIDList.clear();
            developerIDList = recentlyViewedLayer.getRecentlyViewed("Developers");
            StringBuilder sb = new StringBuilder();
            for (int i = 0; i < developerIDList.size(); i++) {
                sb.append(developerIDList.get(i) + ",");
            }
            ...
            new HttpRequest(context, new IHttpResponse() {
                ...
                public void RequestSuccess(Object response) {
                    developerlist.clear();
                    developerlist = new ParseDeveloper().parse((String) response, developerlist);
                    Bind();
                }
    ...
    void Bind() {
        if (developerlist.size() > 0) {
            Collections.reverse(developerlist);
            list.setAdapter(new DevelopersAdapter(context, developerlist, new IProperty() {
                @Override
